    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product() { ProductId = 1, CategoryId = 1, Description = "Güzel maske", Title = "Maske", Price = 100, Stock = 100, IsHomePage = true, IsOnSale = true },
                new Product() { ProductId = 2, CategoryId = 1, Description = "Güzel maske1", Title = "Maske1", Price = 200, Stock = 200, IsHomePage = true, IsOnSale = true }
        );
